...
// Traiter un browscap.ini sans le déclarer dans le php.ini
// http://fr.php.net/manual/fr/function.get-browser.php#70641
function php_get_browser($agent = NULL){
    $agent=$agent?$agent:$_SERVER['HTTP_USER_AGENT'];
    $yu=array();
    $q_s=array("#\.#","#\*#","#\?#");
    $q_r=array("\.",".*",".?");
    $brows=parse_ini_file("lite_php_browscap.ini",true,INI_SCANNER_RAW);
