...
--
-- Serveur: localhost
-- Généré le : Dim 30 Janvier 2011 à 15:32
...
CREATE TABLE IF NOT EXISTS `log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='journal des modifications' AUTO_INCREMENT=12 ;
