...
--
-- Serveur: localhost
-- Généré le : Lun 07 Février 2011 à 10:21
...
CREATE TABLE IF NOT EXISTS `log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='journal des modifications' AUTO_INCREMENT=21 ;
